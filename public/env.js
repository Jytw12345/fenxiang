...
// 后端只需 URL + anon key 即可启用 Supabase 身份体系：它拿用户令牌去问 Supabase 的
// /auth/v1/user 端点做服务端校验，不再依赖 JWT_SECRET，因此无需在后端配置密钥、也不会出现密钥不一致。
...
window.FORCE_LEGACY_AUTH = false// 设为 true 强制走自研账号体系；false 时走 Supabase，后端只需配 SUPABASE_URL + SUPABASE_ANON_KEY（无需 JWT_SECRET）
